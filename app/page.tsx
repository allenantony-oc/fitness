...
const FEATURES: Feature[] = [
  ...
  { slug: "/calculator/calories-burned", title: "Calories Burned", blurb: "MET-based estimate per activity and duration.", icon: Flame, status: "soon", tier: 1 },
  { slug: "/calculator/water-intake", title: "Water Intake", blurb: "Daily hydration target from bodyweight + climate.", icon: HeartPulse, status: "soon", tier: 1 },
  { slug: "/calculator/protein-intake", title: "Protein Intake", blurb: "g/kg recommendations by goal and training level.", icon: Calculator, status: "soon", tier: 1 },
  { slug: "/calculator/ideal-weight", title: "Ideal Weight", blurb: "Devine, Robinson, Hamwi, BMI-range — all four.", icon: Ruler, status: "soon", tier: 1 },
  { slug: "/calculator/lean-mass", title: "Lean Body Mass", blurb: "Boer, James, Hume formulas side-by-side.", icon: Ruler, status: "soon", tier: 1 },
  { slug: "/calculator/pace", title: "Running Pace", blurb: "Pace ↔ time ↔ distance with split tables.", icon: Timer, status: "soon", tier: 1 },
  { slug: "/calculator/heart-rate-zones", title: "Heart Rate Zones", blurb: "Karvonen 5-zone training prescriptions.", icon: HeartPulse, status: "soon", tier: 1 },
  { slug: "/calculator/plate-loading", title: "Plate Loading", blurb: "Visual barbell — which plates per side.", icon: Dumbbell, status: "soon", tier: 1 },
  { slug: "/calculator/wilks", title: "Wilks / DOTS", blurb: "Powerlifting relative-strength scores.", icon: Dumbbell, status: "soon", tier: 1 },
  { slug: "/calculator/recomp-timeline", title: "Recomp Timeline", blurb: "Project weeks-to-goal from your deficit.", icon: Calculator, status: "soon", tier: 1 },
  // Tier 2 — stateful tools
  { slug: "/tools/interval-timer", title: "Interval Timer", blurb: "Tabata, EMOM, AMRAP. PWA + audio cues.", icon: Timer, status: "soon", tier: 2 },
  { slug: "/tools/rest-timer", title: "Rest + Set Logger", blurb: "Tap to log a set, auto-start rest, PR detection.", icon: Timer, status: "soon", tier: 2 },
  { slug: "/library", title: "Exercise Library", blurb: "300+ moves with GIFs, filter by muscle / gear.", icon: Dumbbell, status: "soon", tier: 2 },
  { slug: "/programs", title: "Program Generator", blurb: "PPL, Upper/Lower, 5/3/1, StrongLifts — printable.", icon: Sparkles, status: "soon", tier: 2 },
  { slug: "/tools/overload", title: "Overload Tracker", blurb: "Log lifts, auto-suggest next session's load.", icon: Zap, status: "soon", tier: 2 },
  // Tier 3 — AI
  { slug: "/ai/workout", title: "AI Workout Generator", blurb: "Goal + equipment + time → structured workout.", icon: Sparkles, status: "soon", tier: 3 },
  { slug: "/ai/meal-plan", title: "AI Meal Plan", blurb: "Macro targets → 7-day plan + grocery list.", icon: Sparkles, status: "soon", tier: 3 },
  { slug: "/ai/substitution", title: "AI Substitution", blurb: "Swap exercises by available equipment.", icon: Sparkles, status: "soon", tier: 3 },
  { slug: "/ai/form-coach", title: "AI Form Coach", blurb: "Upload a photo, get cue-by-cue feedback.", icon: Sparkles, status: "soon", tier: 3 },
  // Tier 4 — backend
  { slug: "/journal", title: "Cloud Journal", blurb: "Auth, history sync, charts, public profile.", icon: Zap, status: "soon", tier: 4 },
];
